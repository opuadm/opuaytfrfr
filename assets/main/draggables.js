...
document.addEventListener('DOMContentLoaded', (event) => {
    const element = document.querySelector('#window3');
    ...
    function ensureElementInBoundsOnLoad() {
        ...
        // Set initial position in pixels
        let initialLeft = windowWidth - 1440 - element.offsetWidth; // 486px from the right
        let initialTop = windowHeight - 640 - element.offsetHeight;  // 211px from the bottom
...
document.addEventListener('DOMContentLoaded', (event) => {
    const element = document.querySelector('#window4');
    ...
    function ensureElementInBoundsOnLoad() {
        ...
        // Set initial position in pixels
        let initialLeft = windowWidth - 1200 - element.offsetWidth; // 486px from the right
        let initialTop = windowHeight - 730 - element.offsetHeight;  // 211px from the bottom
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function ensureElementInBoundsOnLoad() {
        ...
        // Set initial position in pixels
        let initialLeft = windowWidth - 759 - element.offsetWidth; // 486px from the right
        let initialTop = windowHeight - 927 - element.offsetHeight;  // 211px from the bottom
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function ensureElementInBoundsOnLoad() {
        ...
        // Set initial position in pixels
        let initialLeft = windowWidth - 1034 - element.offsetWidth; // 486px from the right
        let initialTop = windowHeight - 730 - element.offsetHeight;  // 211px from the bottom
